...
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX69_FINAL.zip
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX69_MULTIAGENT_FINAL.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX69_MULTIAGENT_FINAL.zip")

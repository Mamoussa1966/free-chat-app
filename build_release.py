...
# Release artifact compatibility marker: AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX55_FINAL.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX55_MULTIAGENT_FINAL.zip")

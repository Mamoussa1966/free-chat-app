...
# AI_Council_V22_1_HOTFIX121_2_SINGLE_REQUEST_DETERMINISM_LIVE_CASCADE.zip
# AI_Council_V22_1_HOTFIX121_2_SINGLE_REQUEST_DETERMINISM_LIVE_CASCADE.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_HOTFIX121_2_SINGLE_REQUEST_DETERMINISM_LIVE_CASCADE.zip")

...
# Release-name compatibility markers: HOTFIX64_FINAL.zip and HOTFIX64_MULTIAGENT_FINAL.zip
# Release artifact compatibility markers:
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX64_FINAL.zip
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX64_MULTIAGENT_FINAL.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX64_MULTIAGENT_FINAL.zip")

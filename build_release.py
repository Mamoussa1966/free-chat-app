...
# HOTFIX78_FINAL.zip
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX78_MULTIAGENT_FINAL.zip
# HOTFIX78_FINAL.zip
# AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX78_MULTIAGENT_FINAL.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_FINAL_EXACT_NAMES_UPDATED_HOTFIX78_MULTIAGENT_FINAL.zip")

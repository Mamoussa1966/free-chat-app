...
# AI_Council_V22_1_HOTFIX120_1_GEMINI_LIFECYCLE_HARDENED_FINAL.zip
# AI_Council_V22_1_HOTFIX120_1_GEMINI_LIFECYCLE_HARDENED_FINAL.zip
REQUIRED = [
...
def main() -> int:
    ...
    parser.add_argument("--output", default="AI_Council_V22_1_HOTFIX120_1_GEMINI_LIFECYCLE_HARDENED_FINAL.zip")

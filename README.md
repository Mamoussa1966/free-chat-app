...
V22.1-HOTFIX116-PRODUCTION-HARDENED

HOTFIX116 adds an application-owned Production Core Test Runner. Use **🧪 Run Production Core Tests** in the sidebar; the application executes the local Test Harness and renders the real PASS/NO-GO result. AI providers are not asked to run pytest.

...
- A provider may therefore consume up to 2 seconds per attempted model, but one slow model can never hold its own HTTP request beyond that attempt budget.
